...
namespace culebrita.Estructuras.Padre
{
    public class ClsPrincipal
    {
        ...
        public object incrementaV(int velocidad)
        {
            return velocidad -= 5;
        }
        ...
        public bool MoverLaCulebrita(Queue<Point> culebra, Point posiciónObjetivo,
        ...
        public Point MostrarComida(Size screenSize, Queue<Point> culebra)
        {
        ...
        public void Culebrita()
        {
            ...
            var longitudCulebra = 2; //modificar estos valores y ver qué pasa
